...
const GlowingChip = ({ children }) => {
  return (
    <div>
      <span className="text-sm relative z-10 mb-4 inline-block rounded-full border border-white/40 bg-white/20 px-3 py-1.5 text-white md:mb-0 flex gap-1 w-fit">
        {children}
